...
const INSTALL_RUNNING_OUTPUT = path.join(
  UI_PATH,
  "templates/ui/installing.html"
);
  ...
  return {
    ...
    module: {
      rules: [
        ...
        },
        {
          ...
          include: [/lib\/components\//, /features\//, /src\//]
        },
        {
          test: /\.svg$/,
          use: ["ngtemplate-loader", "html-loader"],
    ...
    resolve: {
      alias: {
        ...
        "lr-infinite-scroll$":
          "~node_modules/lr-infinite-scroll/lrInfiniteScroll.js",
        "angular-tz-extensions$":
          "~node_modules/angular-tz-extensions/lib/angular-tz-extensions.js",
        "ng-toast-provider$": "~node_modules/ng-toast/src/scripts/provider.js",
        "ng-toast-directives$":
          "~node_modules/ng-toast/src/scripts/directives.js",
